...
import CrisisImage from "../../assets/Resources/resources-crisis.jpg";
  ...
  return (
    <section id="crisis" className="py-20 px-6 bg-white border-t border-zinc-200">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <img src={CrisisImage} alt="Crisis Support Resources" className="w-full h-full object-cover rounded-xl" />
        </div>
