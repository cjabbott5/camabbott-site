...
import PeerImage from "../../assets/Resources/resources-group.jpg";
  ...
  return (
    <section id="peer" className="py-20 px-6 bg-zinc-900 text-white border-t border-zinc-800">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <img src={PeerImage} alt="Peer & Group Support Resources" className="w-full h-full object-cover rounded-xl" />
