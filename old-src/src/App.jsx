...
import QueerPsychCare from "./pages/Resources/QueerPsychCare";
import HospitalWelcome from "./pages/Resources/HospitalWelcome";
import MentalHealthcareReform from "./pages/Resources/MentalHealthcareReform";
      ...
      <div className="bg-white text-gray-900 min-h-screen flex flex-col">
        ...
        <main className="flex-grow">
          <Routes>
            ...
            <Route path="/essays/queer-psych-care" element={<QueerPsychCare />} />
            <Route path="/essays/hospital-welcome" element={<HospitalWelcome />} />
            <Route path="/essays/healthcare-reform" element={<MentalHealthcareReform />} />
