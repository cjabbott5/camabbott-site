...
export default function SettingChart({ data, onSettingClick }) {
  return (
    <div className="bg-zinc-900 text-white shadow rounded-xl p-4 border">
...
>
  ...
  <Bar dataKey="safe" name="Felt Safe" fill="#7DD3FC" barSize={20} onClick={(data) => onSettingClick(data)} />
  <Bar dataKey="harmful" name="Harmed" fill="#EF4444" barSize={20} onClick={(data) => onSettingClick(data)} />
</BarChart>
