...
export default function Home() {
      ...
      <section className="relative w-full py-12 px-4 mt-8 text-black overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto space-y-4">
          ...
          <motion.p
            ...
            className="text-2xl italic mt-4"
          >
  ...
  <div className="flex gap-4">
    <button className="bg-cherry-400 text-black px-4 py-2 rounded-full text-sm hover:scale-105 hover:shadow-xl hover:bg-white transition-all duration-300">
      Read My Story
    </button>
    <button className="bg-black text-white px-4 py-2 rounded-full text-sm  hover:bg-powderBlue-400 hover:text-black transition">
      Let’s Connect
    </button>
  </div>
</div>
